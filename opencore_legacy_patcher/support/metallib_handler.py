...
METALLIB_INSTALL_PATH: str  = "/Library/Application Support/ybronst/MetallibSupportPkg"
METALLIB_API_LINK:     str  = "https://YBronst.github.io/MetallibSupportPkg/manifest.json"
